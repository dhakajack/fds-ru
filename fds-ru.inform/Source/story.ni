...
Rule for printing a locale paragraph about the microfluidic synthesis unit:
	...
	otherwise:
		...
		if the disjoncteurs are broken:
			say "видны внутренности установки";
		otherwise:
			say "виден ";
			if the microfluidic synthesis unit is broken:
				say "дефектный";
...
To say descDecon:
	if the consciousness of the player is:
		...
		-- 4: 
			tell showerDesc;
	say ". Дверь к востоку ведет в коридор, а к северу [unicode 8212] на лестницу"
...
To credits:
	...
	say " Валентину Коптельцеву и Дэвиду Уайту (David White) (английская версия); Антону Ласточкину и Сергею Можайскому (русская версия).";
	close HTML tag;
	open HTML tag "li";
