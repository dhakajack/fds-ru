...
mouseDogDialogue is {	
{"Мышь? Что еще за мышь?»[line break]«Мышь, которая здесь живет.»[line break]«Та самая проклятая мышь, которая постоянно тырит крошки вокруг моей кормушки?»[line break]«Да, именно так. Еще раз – я просто хотел извиниться, если расстроил тебя."},
{"Не переживай из-за этого. На твоем месте я поступил бы так же.»[line break]«Спасибо.»[line break]«Скажи, мышь, у тебя есть имя?»[line break]","«Нет, мы, мыши, обходимся без имен. Так что можешь звать меня просто Мышью, точнее – „Мышом[quotation mark]. Ну, а тебя как звать?»[line break]","«„Lucky[quotation mark]. Ну, по крайней мере так называли меня в моей семье, пока я не попал сюда. Местные живодеры называют меня „Объект 205-Альфа[quotation mark], но „Лаки[quotation mark] мне как-то больше нравится».[line break]«Хорошо, Лаки."},
{"Мыш, ты можешь мне кое-что объяснить? Как так получилось, что ты, крошечная мышка, проглотил меня – крупного, сильного пса, в десятки раз превосходящего тебя в размерах?»[line break]","«Ты знаешь, я задавался тем же вопросом. Постой-ка -- ты сказал «пес»? Я думал, ты волк!»[line break]«Нет, я собака.»[line break]«Ты уверен?»[line break]«Да, вполне."},
...
EverybodyDialogue is { "«What an incredible sensation![quotation mark] marvels the scientist.[line break]«You get used to it after a while,[quotation mark] says the mouse laconically.[line break]«Tell her the plan, Lucky,[quotation mark] suggests the slice of brain.[line break]«Okay,[quotation mark] says the dog, [quotation mark]From the top… Number one: we find the rest of Julien's brain; number two: we find a way out of the installation; and finally, number more-than-two: we look for my family.[quotation mark]",
"«Um, okay,[quotation mark] says Isabelle. [quotation mark]But first we have to get beyond the room where you found me, and to do that, we have to synthesize an effective cure.[quotation mark][line break]«Impossible,[quotation mark] remarks the mouse with finality.[line break]«Why?[quotation mark] asks the scientist, a bit off balance.[line break]«It's a question of mathematics,[quotation mark] answers the mouse pedantically. [quotation mark]Lucky's plan starts with item number one. There is nothing before number one.[quotation mark][line break]«Number zero?[quotation mark] suggests Isabelle.[paragraph break][roman type][quotation mark]…[quotation mark][paragraph break][italic type]«Okay,[quotation mark] says Isabelle. [quotation mark]How about we renumber? One: prepare the cure; two: get out of the installation; three: find Lucky's family. Does that work for you?[quotation mark][line break]«Sure,[quotation mark] says Lucky, [quotation mark]that sounds entirely reasonable.[quotation mark][line break]«And it's mathematically correct,[quotation mark] adds the mouse.",
